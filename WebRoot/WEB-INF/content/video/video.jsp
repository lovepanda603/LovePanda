			        ...
			        <li>
			            <div class="am-gallery-item am_list_block">
			                ...
			                <div class="am_listimg_info">
			                	<a href="${base}/video/detail/${l.id}"><i class="am-icon-play-circle"></i><span>
			                		<c:if test="${fn:length(l.title)>20}">
			                			${fn:substring(l.title,0,20)}...
			                		</c:if>
			                		<c:if test="${fn:length(l.title)<=20}">
			                			${l.title}
			                		</c:if>
			                	...
			                	<span class="am_imglist_user_ico">
					                <img src="${base}/attached/avatar/${l.avatar}" onerror="javascript:this.src='${base}/attached/avatar/default.jpg'" style="width: 20px;height: 20px" alt="">
				                	<span class="am_imglist_user_font">${l.username}</span>
			                	</span>
