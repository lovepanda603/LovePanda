	  	...
	  	<div class="am-u-sm-12">
			<form action="${base}/admins/blogDeletedList/" method="get">
	  		...
	  		<table class="am-table am-table-bordered am-table-striped am-table-hover">
				...
				<c:set var="actionUrl" value="${base}/admins/blogDeletedList?blog.title=${blog.title}&bozhu=${bozhu}&blog.ispublic=${blog.ispublic}&blog.level=${blog.level}&page=" />
