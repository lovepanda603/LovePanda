  ...
  <div class="admin-content" id="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
		<form class="am-form" action="${base}/admins/picRecommendUpdate/" method="post" enctype="multipart/form-data">
	  		<input type="hidden" name="pic.id" value="${pic.id}">
	  		<input type="hidden" name="pic.deleted" value="${pic.deleted}">
	  		<input type="hidden" name="pic.create_time" value="${pic.create_time}">
			  <fieldset>
			    <legend>修改首页图片推荐</legend>
				
			
			    <div class="am-form-group">
			      <label for="admin-admin-picRec-form-title">推荐标题</label>
			      <input type="text" class="" id="admin-admin-picRec-form-title" name="pic.title" value="${pic.title}" placeholder="请输入推荐标题">
			    </div>
				...
				<script>
				  $(function() {
				    ...
				    $('#file-list').html(${pic.image});
				  });
				</script>
			    </div>
			    <div class="am-form-group">
			      <label for="admin-admin-picRec-form-url">URL</label>
			      <input type="url" id="doc-vld-url-2" placeholder="请输入网址"  name="pic.url" value="${pic.url}"/>
			    </div>
			     <div class="am-form-group">
			      <label for="admin-admin-picRec-form-sn">排序</label>
			      <input type="number" id="admin-admin-picRec-form-sn" name="pic.sn" value="${pic.sn}" placeholder="请输入排序号，不输入默认为其ID" />
			    </div>
