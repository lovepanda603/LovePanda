  ...
  <div class="admin-content" id="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
		<form class="am-form" action="${base}/admins/linkSave/" method="post" enctype="multipart/form-data">
			  <fieldset>
			    <legend>新建友情链接</legend>
			    <div class="am-form-group">
			      <label for="admin-admin-picRec-form-title">网站名</label>
			      <input type="text" class="" id="admin-admin-picRec-form-title" name="link.title" placeholder="请输入网站名" required>
			    </div>
			    <div class="am-form-group">
			      <label for="admin-admin-picRec-form-url">URL</label>
			      <input type="url" id="doc-vld-url-2" placeholder="请输入网址"  name="link.url" required/>
			    </div>
			     <div class="am-form-group">
			      <label for="admin-admin-picRec-form-sn">排序</label>
			      <input type="number" id="admin-admin-picRec-form-sn" name="link.sn" placeholder="请输入排序号，不输入默认为其ID" />
			    </div>
