...
<%@ include file="/WEB-INF/content/admins/side.jsp"%> 
  ...
  <div class="admin-content" id="admin-content">
	...
	<div class="am-g">
		...
		<form class="am-form-inline" method="post" action="${base}/admins/iplogIpSum/">
          ...
          <table class="am-table am-table-striped am-table-hover table-main am-table-bordered">
            <thead>
              <tr>
                ...
                <th class="table-title">访问次数</th>
                <th class="table-set" width="230px">操作</th>
              </tr>
          </thead>
          <tbody>
          	<c:forEach items="${Ips}" var="g">
	            <tr>
	              <td>${g.ip}</td>
	              <td>${g.sumip}</td>
	              <td>
	                <div class="am-btn-toolbar">
	                  ...
	                  <div class="am-btn-group am-btn-group-xs">
	                  <a class="am-btn am-btn-default am-btn-xs am-text-primary" href="${base}/admins/iplogIpDetail?ip=${g.ip}&start=${start}&end=${end}"><span class="am-icon-chevron-circle-right"></span> IP访问详情</a>
	                  </div>
	                </div>
	              </td>
	            </tr>
